...
wandb.init(project="OcularVisionMLProject", entity="nealj06", name="updated_project")
wandb.config = {
  "learning_rate": 0.001,
  "epochs": 1,
  "batch_size": 8,
...
cnn_neural_network.fc = torch.nn.Linear(in_features=512, out_features=8, bias=True)
...
for data in train_dataloader:
    ...
    precision, recall, f1score, support = precision_recall_fscore_support(output_categories, model_predictions_discrete,
                                            labels=(0,1,2,3,4, 5, 6, 7), zero_division=0)
